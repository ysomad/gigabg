...
func (s *shopPanel) endDrag(lay ui.GameLayout, mx, my int, drag *dragState) {
...
func (s *shopPanel) getDropPosition(lay ui.GameLayout, mx int) int {
...
func (s *shopPanel) handleButtonClick(lay ui.GameLayout, mx, my int) bool {
...
func (s *shopPanel) updateHover(lay ui.GameLayout, mx, my int) (*api.Card, ui.Rect, bool) {
	shop := s.client.Shop()
...
func (s *shopPanel) drawCards(screen *ebiten.Image, lay ui.GameLayout, drag *dragState) {
	shop := s.client.Shop()
...
func (s *shopPanel) drawButtons(screen *ebiten.Image, font *text.GoTextFace, lay ui.GameLayout) {
	refresh, upgrade, freeze := ui.ButtonRects(lay.BtnRow)
	sc := ui.ActiveRes.Scale()
	sw := float32(sc)
